...
export function TopBar() {
    return (
        <View style={{ backgroundColor: "#ec0000", position:"absolute", top: "3.8%", flexDirection: "row", width: "100%", paddingVertical: "5%", paddingHorizontal:12, justifyContent: "space-between" }} >
            ...
            <View style={{ flexDirection: "row", gap: 16 }}>
                <Ionicons name="ios-chatbox-ellipses-outline" size={24} color="#f0f0f0" />
